...
public final class CardCreditRepository {
    ...
    public Optional<CardCreditSnapshot> findCard(Connection connection, UUID cardId) throws SQLException {
        String sql = """
                SELECT card_type,
                       status,
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                ...
                return Optional.of(new CardCreditSnapshot(
